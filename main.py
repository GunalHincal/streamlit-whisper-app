...
model_options = {
    "tiny": {
        ...
        "description": "Tiny modeli en hafif ve en hızlı modeldir. Mobil cihazlar ve düşük donanımlı sistemler için uygundur. Ancak doğruluğu düşüktür.",
    },
    "base": {
        "parameters": "74M",
        "VRAM": "~1 GB",
        ...
        "description": "Base modeli, hafif ama daha doğru bir modeldir. Gerçek zamanlı transkripsiyon için uygundur.",
    },
    "small": {
        "parameters": "244M",
        "VRAM": "~2 GB",
        ...
        "description": "Small modeli, düşük gecikmeli ses işleme ve orta seviye doğruluk isteyen kullanıcılar için idealdir.",
    },
    "medium": {
        "parameters": "769M",
        "VRAM": "~5 GB",
        ...
        "description": "Medium modeli, profesyonel transkripsiyon işleri için uygundur. Daha fazla VRAM gerektirir.",
    },
    "large": {
        "parameters": "1550M",
        "VRAM": "~10 GB",
        ...
        "description": "Large modeli, en yüksek doğruluğa sahiptir. Büyük projeler ve akademik çalışmalar için uygundur.",
    },
    "turbo": {
        "parameters": "809M",
        "VRAM": "~6 GB",
        ...
        "description": "Turbo modeli, Large modeline göre daha hızlıdır ama doğrulukta hafif bir düşüş olabilir.",
    },
}
